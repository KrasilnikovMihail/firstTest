...
Сценарий: Проверка создания номенклатуры в ERP
	Когда я подключаю TestClient "ERP" логин "Администратор (ОрловАВ)" пароль ""
	...
	И из выпадающего списка с именем "ВидНоменклатурыОбязательныеПоля" я выбираю по строке 'Продукция'	
